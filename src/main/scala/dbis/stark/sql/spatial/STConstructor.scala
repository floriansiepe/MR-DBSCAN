...
case class STPoint(private val exprs: Seq[Expression]) extends Expression with CodegenFallback  {
...
case class MakeSTObject(private val exprs: Seq[Expression]) extends Expression with CodegenFallback {
