...
#sbatch run.slurm /home/siepef/datasets/densired_2.csv 2 0.1 100 128 /home/siepef/experiments/eps out.csv 0.01
sbatch run.slurm "$DATASET" "$DIM" "$EPS" "$MINPTS" "$EXP_DIR" "$OUT"
